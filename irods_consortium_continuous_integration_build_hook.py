...
def install_os_specific_dependencies_apt():
    update_local_package_repositories()
    irods_python_ci_utilities.install_os_packages(['make', 'libssl-dev', 'libxml2-dev', 'libcurl4-gnutls-dev', 'gcc', 'libpam-dev'])

def install_os_specific_dependencies_yum():
    irods_python_ci_utilities.install_os_packages(['make', 'gcc', 'openssl-devel', 'libxml2-devel', 'curl-devel', 'pam-devel'])
